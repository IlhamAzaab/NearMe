  ...
  const icons = {
    ...
    biryani: (
      <svg viewBox="0 0 64 64" className="w-10 h-10">
        ...
        <path d="M26 28 Q28 22, 30 28" stroke="#9E9E9E" fill="none" strokeWidth="1.5"/>
        <path d="M32 26 Q34 20, 36 26" stroke="#9E9E9E" fill="none" strokeWidth="1.5"/>
        <path d="M38 28 Q40 22, 42 28" stroke="#9E9E9E" fill="none" strokeWidth="1.5"/>
      </svg>
    ),
    desserts: (
      <svg viewBox="0 0 64 64" className="w-10 h-10">
...
const Home = () => {
  ...
  const fetchNotificationCount = async () => {
    try {
      const token = localStorage.getItem("token");
      const res = await fetch("http://localhost:5000/customer/notifications?limit=100", {
      ...
      <main className="px-4 py-5 max-w-6xl mx-auto">
          ...
          <div className="flex gap-4 overflow-x-auto pb-2 -mx-4 px-4 scrollbar-hide">
            {categories.map((category) => (
              ...
              >
                ...
                <span className={`text-sm font-medium ${selectedCategory === category.id ? "text-white" : "text-[#FF7A00]"}`}>{category.name}</span>
              </button>
            ))}
          </div>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="mt-4 text-gray-500 text-sm font-medium">Finding delicious options...</p>
          </div>
        ) : activeTab === "restaurant" ? (
          /* Restaurant Section */
          <div>
            ...
            {featuredRestaurant && (
              <div className="mb-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Featured Restaurant</h3>
                <div 
                  onClick={() => navigate(`/restaurant/${featuredRestaurant.id}/foods`)}
                  className="relative overflow-hidden rounded-3xl cursor-pointer group"
                >
                  <img
                    src={featuredRestaurant.logo_url || "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800"}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <div className="flex items-center gap-3 text-white/90 text-sm">
                      ...
                      <span>{featuredRestaurant.cuisine || "Multi-cuisine"}</span>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button className="text-[#FF7A00] text-sm font-medium hover:text-orange-600 transition-colors">See All</button>
              </div>
              ...
              <div className="flex lg:grid lg:grid-cols-4 gap-4 overflow-x-auto lg:overflow-x-visible pb-4 lg:pb-0 -mx-4 px-4 lg:mx-0 lg:px-0 scrollbar-hide">
                {restaurants.slice(1, 9).map((r) => (
                  ...
                  >
                    <div className="relative">
                      <img
                        src={r.logo_url || "https://images.unsplash.com/photo-1552566626-52f8b828add9?w=400"}
            ...
            {restaurants.length > 0 && (
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-gray-900">All Restaurants</h3>
                </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 py-1">
                        <div className="flex items-center gap-2 mb-1">
                          <h4 className="font-bold text-gray-900 truncate">{r.restaurant_name}</h4>
                          <span className="w-4 h-4 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
                            <svg className="w-2.5 h-2.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                            </svg>
                        ...
                        <div className="flex items-center gap-3 text-sm">
                          ...
                          {r.delivery_fee === 0 ? (
                            <span className="text-green-600 font-medium text-xs">Free delivery</span>
                          ) : r.delivery_fee > 0 ? (
                            <span className="text-gray-400 text-xs">Rs. {r.delivery_fee} delivery</span>
                          ) : null}
                        </div>
                      </div>
                    </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {allFoods.map((food) => (
                <div
                  key={food.id}
                  onClick={() => navigate(`/restaurant/${food.restaurant_id}/food/${food.id}`)}
                ...
                >
                  <div className="relative">
                    <img
                      src={food.image_url || "https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400"}
                      alt={food.name}
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-[#FF7A00]">Rs. {food.price}</span>
                      {food.prep_time && (
        ...
        {!loading && (activeTab === "food" ? allFoods : restaurants).length === 0 && (
          <div className="text-center py-20">
            <div className="w-24 h-24 mx-auto mb-4 bg-gray-100 rounded-full flex items-center justify-center">
              <span className="text-5xl">🔍</span>
            </div>
            <h3 className="text-lg font-semibold text-gray-700 mb-2">No results found</h3>
            <p className="text-gray-500 text-sm">Try adjusting your search or browse categories</p>
          </div>
        )}
      </main>
