    ...
    >
      ...
      <header className="flex items-center bg-white p-4 pb-2 justify-between sticky top-0 z-10 border-b border-[#dbe6e3]">
        <div
          ...
          className="text-[#111816] flex size-12 shrink-0 items-center cursor-pointer"
        >
        ...
        <div className="flex w-12 items-center justify-end">
          <button
            ...
            disabled={refreshing}
            className={`flex size-12 cursor-pointer items-center justify-center rounded-lg bg-transparent text-[#111816] ${refreshing ? "animate-spin" : ""}`}
          >
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white/95 backdrop-blur-md border-t border-[#dbe6e3] flex justify-around items-center px-4 py-3 z-20">
        <button
          onClick={() => navigate("/manager/dashboard")}
          className="flex flex-col items-center gap-1 text-[#618980]"
        >
          <span className="material-symbols-outlined">dashboard</span>
          <span className="text-[10px] font-bold">Home</span>
        </button>
        <button className="flex flex-col items-center gap-1 text-[#13ecb9]">
          <span
          ...
          <span className="text-[10px] font-bold">Deposits</span>
        </button>
        <button
        ...
        <button
          onClick={() => navigate("/manager/restaurants/manage")}
          className="flex flex-col items-center gap-1 text-[#618980]"
        >
