...
const ManagerEarnings = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f6f8f7]">
      {/* Gradient Header */}
      <header className="relative w-full bg-gradient-to-br from-[#064e3b] via-[#065f46] to-[#13ec80] p-4 pb-6 rounded-b-lg shadow-lg">
          ...
          {["daily", "weekly", "monthly", "all"].map((p) => (
            <button
              ...
              className={`flex-shrink-0 px-4 py-2 rounded-full text-sm font-semibold transition-all ${
                period === p
                  ? "bg-white text-[#065f46] shadow-md"
                          ...
                          <div className="border-t border-gray-100 px-4 pb-4 pt-3 bg-gray-50/50">
                            ...
                            <div className="bg-white rounded-xl p-3 border border-gray-200 space-y-2">
                              ...
                              <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium text-gray-800">
                                  Rs.
                                  {parseFloat(order.delivery_fee || 0).toFixed(
                                    0,
                                  )}
                                </span>
                              </div>
                              <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium text-gray-800">
                                  Rs.
                                  {parseFloat(order.service_fee || 0).toFixed(
                                    0,
                                  )}
                                </span>
                              </div>
