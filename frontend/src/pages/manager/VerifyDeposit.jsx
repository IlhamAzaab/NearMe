...
export default function VerifyDeposit() {
  ...
  if (loading) {
    return (
      <div className="relative flex min-h-screen w-full flex-col bg-[#f6f8f8] max-w-md mx-auto lg:max-w-2xl">
        {/* Skeleton Header */}
        <div className="sticky top-0 z-50 flex items-center bg-white/80 backdrop-blur-md px-4 py-3 justify-between border-b border-slate-200">
      ...
      <div className="relative flex min-h-screen w-full flex-col bg-[#f6f8f8] max-w-md mx-auto lg:max-w-2xl">
        <div className="flex flex-col items-center justify-center h-screen gap-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#13ecb9] rounded-lg font-medium"
          >
            Go Back
          </button>
        </div>
  ...
  return (
    <div
      className="relative flex min-h-screen w-full flex-col bg-[#f6f8f8] max-w-md mx-auto lg:max-w-2xl"
    ...
    >
      ...
      <div className="sticky top-0 z-50 flex items-center bg-white/80 backdrop-blur-md px-4 py-3 justify-between border-b border-slate-200">
        ...
        <div className="flex items-center gap-2">
          <button className="flex items-center justify-center size-10 rounded-full bg-[#13ecb9]/10 text-[#13ecb9]">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white p-4 border-t border-slate-200 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
