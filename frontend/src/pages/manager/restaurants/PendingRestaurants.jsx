              ...
              <div className="lg:col-span-2">
                {!selectedRestaurant ? (
                  ...
                  <div className="space-y-6 max-h-[85vh] overflow-y-auto">
                    ...
                    {details.restaurant.latitude &&
                      details.restaurant.longitude && (
                        <div className="bg-white rounded-lg shadow p-6">
                          <h3 className="text-lg font-semibold text-gray-800 mb-4">
                            Restaurant Location
                          </h3>
                          <div className="mb-3">
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                              Coordinates:{" "}
                              {Number(details.restaurant.latitude).toFixed(6)},{" "}
                              {Number(details.restaurant.longitude).toFixed(6)}
                            </p>
                          </div>
                          <div className="rounded-lg overflow-hidden border border-gray-300">
                            <MapContainer
                              center={[
                                Number(details.restaurant.latitude),
                                Number(details.restaurant.longitude),
                              ]}
                              zoom={15}
