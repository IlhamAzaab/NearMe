            ...
            <div className="w-full max-w-md backdrop-blur-xl bg-white/90 border border-green-100 rounded-3xl shadow-2xl shadow-green-100/50 p-8 transform transition-all duration-500 animate-fade-in-down z-10">
                <div className="text-center">
                    ...
                    <div className="inline-block mb-6 p-5 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full shadow-lg">
                        ...
                        >
                            {/* Scooter body */}
                            <ellipse cx="14" cy="48" rx="8" ry="8" fill="currentColor" opacity="0.9"/>
                            <ellipse cx="50" cy="48" rx="8" ry="8" fill="currentColor" opacity="0.9"/>
                            <ellipse cx="14" cy="48" rx="4" ry="4" fill="#fff" opacity="0.3"/>
                            <ellipse cx="50" cy="48" rx="4" ry="4" fill="#fff" opacity="0.3"/>
                            {/* Scooter frame */}
                            <path d="M14 48 L24 32 L44 32 L50 48" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M24 32 L28 24 L40 24 L44 32" fill="currentColor" opacity="0.8"/>
                            {/* Handlebar */}
                            <path d="M40 24 L44 16 L52 16" stroke="currentColor" strokeWidth="3" fill="none" strokeLinecap="round"/>
                            <circle cx="52" cy="16" r="3" fill="currentColor"/>
                            {/* Delivery box */}
                            <rect x="18" y="14" width="16" height="12" rx="2" fill="#86EFAC" stroke="currentColor" strokeWidth="2"/>
                            <path d="M22 20 L26 23 L32 17" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                            {/* Speed lines */}
                            <path d="M4 36 L10 36" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
                            <path d="M2 42 L8 42" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.4"/>
                            <path d="M4 48 L9 48" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.5"/>
                        </svg>
                    </div>
