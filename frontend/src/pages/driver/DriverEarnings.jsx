...
export default function DriverEarnings() {
  ...
  const getEarningsAmount = (item) =>
    Number(item?.driver_earnings || 0) + Number(item?.tip_amount || 0);
  ...
  return (
    <div
      className="relative flex h-screen w-full flex-col max-w-md mx-auto bg-[#f6f8f6] text-[#111812] overflow-hidden"
    ...
    >
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    {Number(item.bonus_amount || 0) > 0 && (
                      <p className="text-[10px] text-[#13ec37] font-bold">
      ...
      <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-32 h-1 bg-black/10 rounded-full z-30"></div>
    </div>
  );
}
